...
function DashboardApp() {
  ...
  const handleStudentOverviewClick = () => {
    ...
    <div className="app">
      <div className="sidebar">
        ...
        <ul>
          ...
          <div className="sidebar-item" onClick={handleStudentOverviewClick}>
      ...
      <div className="main-container">
        ...
        <div div className="main-content">
          <div className="content-grid">
            <div
              className="box course-completion"
              onClick={handleCourseCompletionClick}
            >
            ...
            <div
              className="box upcoming-sessions"
